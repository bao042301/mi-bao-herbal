...
st.markdown("""
    ...
    * { color: #4A4E31 !important; font-family: 'Noto Sans TC', sans-serif !important; }
    ...
    h3 { 
        font-size: 1.35rem !important; /* 從 1.6rem 調小，更精緻 */
    ...
    div[aria-checked="true"] {
        ...
        box-shadow: 0 4px 15px rgba(122, 132, 80, 0.15) !important;
    }
...
if st.session_state.step == 1:
    ...
    q1 = st.radio("", ["我有些疲累，渴望溫潤透亮的晨光...", "我有些沉重，想找回輕盈自在的微風...", "我有些燥熱，想念山間清徹甘甜的泉水..."], index=None, key="v21_q1")
