...
st.markdown("""
    ...
    * { color: #4A4E31 !important; font-family: 'Noto Sans TC', sans-serif !important; }
    ...
    .block-container {
        ...
        padding-bottom: 80px !important; /* 為固定頁尾預留空間 */
    }
    ...
    /* 結果清單文字與價格放大 */
    .benefit-item { font-size: 0.95rem !important; line-height: 1.6 !important; }
    .price-text { font-size: 1.15rem !important; font-weight: bold !important; color: #7A8450 !important; }
    ...
    .footer-text { font-size: 0.7rem !important; color: #8B8B7A !important; line-height: 1.4 !important; margin: 0 !important; }
...
if st.session_state.step == 1:
    ...
    q1 = st.radio("", ["我有些疲累，渴望溫潤透亮的晨光...", "我有些沉重，想找回輕盈自在的微風...", "我有些燥熱，想念山間清徹甘甜的泉水..."], index=None, key="v43_q1", label_visibility="collapsed")
