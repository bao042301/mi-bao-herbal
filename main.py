...
# 1. 究極視覺鎖定 (選中底色強顯修正、價格置中放大、複製按鈕強顯、選項靠左)
...
st.markdown("""
    ...
    * { color: #4A4E31 !important; font-family: 'Noto Sans TC', sans-serif !important; }
    ...
    /* 【究極修正】當選項被選中後，覆蓋 nth-of-type 顏色，強制改變文字底圖底色 */
    [data-testid="stRadio"] div[role="radiogroup"] div[aria-checked="true"] > label { 
        background-color: #E9EDC9 !important; /* 選中時統一改為品牌橄欖綠 */
...
if st.session_state.step == 1:
    ...
    st.markdown('<p class="question-text">當您靜下心，您的身體正低聲說...？</p>', unsafe_allow_html=True)
    q1 = st.radio("", ["我有些疲累，渴望溫潤透亮的晨光", "我有些沉重，想找回輕盈自在的微風", "我有些燥熱，想念山間清徹甘甜的泉水"], index=None, key="v54_q1", label_visibility="collapsed")
    ...
    q2 = st.radio("", ["長時間待在冷氣房，手腳冰冷循環差", "生活忙碌常熬夜，作息不規律隨意吃", "壓力大節奏快，心神緊繃難入眠"], index=None, key="v54_q2", label_visibility="collapsed")
