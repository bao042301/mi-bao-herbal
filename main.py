...
st.markdown("""
    ...
    * { color: #4A4E31 !important; font-family: 'Noto Sans TC', sans-serif !important; }
    ...
    /* 【關鍵修復 1】縮減容器間距，防止底部卡到 */
    .block-container {
        padding-top: 1.5rem !important; /* 從 5rem 縮小到 1.5rem，內容往上提 */
    ...
    /* 選中狀態 */
    [data-testid="stRadio"] div[aria-checked="true"] label { border: 2px solid #7A8450 !important; }
...
if st.session_state.step == 1:
    ...
    q1 = st.radio("", ["我有些疲累，渴望溫潤透亮的晨光...", "我有些沉重，想找回輕盈自在的微風...", "我有些燥熱，想念山間清徹甘甜的泉水..."], index=None, key="v35_q1")
    ...
    q2 = st.radio("", ["長時間待在冷氣房，循環緩慢且手腳冰冷", "工作忙碌常熬夜，晚餐不規律導致不適", "壓力大節奏快，晚上難以入眠且心神不寧"], index=None, key="v35_q2")
    ...
    q3 = st.radio("", ["感覺臉龐恢復紅潤元氣，重新出發", "感覺身體找回輕盈律動，不再束縛", "感覺內心恢復安靜穩定，優雅從容"], index=None, key="v35_q3")
    ...
    choice = st.radio("", opts, index=None, key="v35_choice")
    ...
    else: diag, m_tea, a_tea = "清泉系", "金菊牛蒡茶 (15入) + 黃耆元元氣茶 (5入)", "玫瑰決明茶 (14入) + 當歸紅棗茶 (6入)"
