...
st.markdown("""
    ...
    * { color: #4A4E31 !important; font-family: 'Noto Sans TC', sans-serif !important; }
    ...
    [data-testid="stRadio"] div[role="radiogroup"] div[aria-checked="true"] label { 
        background-color: #E9EDC9 !important; /* 選中時的底色改為溫潤橄欖綠 */
        border: 1.8px solid #7A8450 !important;
        font-weight: bold !important;
        box-shadow: 0 2px 8px rgba(122, 132, 80, 0.1) !important;
    }
...
if st.session_state.step == 1:
    ...
    q1 = st.radio("", ["我有些疲累，渴望溫潤透亮的晨光", "我有些沉重，想找回輕盈自在的微風", "我有些燥熱，想念山間清徹甘甜的泉水"], index=None, key="v63_q1", label_visibility="collapsed")
    ...
    q2 = st.radio("", ["長時間待在冷氣房，手腳冰冷循環差", "生活忙碌常熬夜，作息不規律隨意吃", "壓力大節奏快，心神緊繃難入眠"], index=None, key="v63_q2", label_visibility="collapsed")
    ...
    q3 = st.radio("", ["感覺臉龐恢復紅潤元氣，重新出發", "感覺身體找回輕盈律動，不再束縛", "感覺內心恢復安靜穩定，從容自在"], index=None, key="v63_q3", label_visibility="collapsed")
    ...
    opts = ["是的，我是新朋友", "我是老朋友"]
    choice = st.radio("", opts, index=None, key="v63_choice", label_visibility="collapsed")
    ...
    st.markdown(f"""
    <div style="background-color: #FFFFFF; padding: 15px; border-radius: 15px; border: 1px solid #E9EDC9;">
