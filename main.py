...
st.markdown("""
    ...
    * { color: #4A4E31 !important; font-family: 'Noto Sans TC', sans-serif !important; }
    ...
    [data-testid="stRadio"] label {
        ...
        text-align: left !important; transition: all 0.3s ease !important; cursor: pointer !important;
    ...
    /* 【究極修正】使用 :has 選擇器鎖定勾選狀態，徹底壓制 nth-of-type 權重 */
    /* 當該選項內的 input 被選中時，強制改變 label 的背景與邊框 */
    [data-testid="stRadio"] div[role="radiogroup"] div:has(input:checked) label {
        background-color: #E9EDC9 !important; /* 統一轉為選中橄欖綠 */
        border: 2px solid #7A8450 !important;
        font-weight: bold !important;
        box-shadow: 0 2px 8px rgba(122, 132, 80, 0.15) !important;
    }
    
    /* 針對不支援 :has 的瀏覽器提供 aria-checked 雙重保險 */
...
if st.session_state.step == 1:
    ...
    q1 = st.radio("", ["我有些疲累，渴望溫潤透亮的晨光", "我有些沉重，想找回輕盈自在的微風", "我有些燥熱，想念山間清徹甘甜的泉水"], index=None, key="v69_q1", label_visibility="collapsed")
    ...
    q2 = st.radio("", ["長時間待在冷氣房，手腳冰冷循環差", "生活忙碌常熬夜，作息不規律隨意吃", "壓力大節奏快，心神緊繃難入眠"], index=None, key="v69_q2", label_visibility="collapsed")
    ...
    q3 = st.radio("", ["感覺臉龐恢復紅潤元氣，重新出發", "感覺身體找回輕盈律動，不再束縛", "感覺內心恢復安靜穩定，從容自在"], index=None, key="v69_q3", label_visibility="collapsed")
    ...
    opts = ["是的，我是新朋友", "我是老朋友"]
    choice = st.radio("", opts, index=None, key="v69_choice", label_visibility="collapsed")
