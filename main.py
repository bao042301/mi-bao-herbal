...
st.markdown("""
    ...
    * { color: #4A4E31 !important; font-family: 'Noto Sans TC', sans-serif !important; }
    ...
    div[data-baseweb="radio"] div {
        ...
        border-radius: 18px !important; padding: 15px 20px !important; 
        margin-bottom: 35px !important; /* 從 25px 增加到 35px */
        transition: all 0.3s ease !important;
        box-shadow: 0 2px 8px rgba(0,0,0,0.02) !important;
    }
    /* 選中狀態 */
    div[aria-checked="true"] {
        background-color: #7A8450 !important; border-color: #7A8450 !important;
        box-shadow: 0 6px 20px rgba(122, 132, 80, 0.18) !important;
    }
    ...
    .stTextInput input {
        ...
        border-radius: 12px !important; color: #4A4E31 !important; padding: 12px !important;
    }
    ...
    .stButton > button {
        ...
        border-radius: 30px !important; height: 3.8em !important; font-weight: bold !important; border: none !important;
    }
    ...
    .result-card { 
        ...
        border-radius: 25px !important; border: 1px solid #E9EDC9 !important;
...
if st.session_state.step == 1:
    ...
    q1 = st.radio("", ["我有些疲累，渴望溫潤透亮的晨光...", "我有些沉重，想找回輕盈自在的微風...", "我有些燥熱，想念山間清徹甘甜的泉水..."], index=None, key="v211_q1")
    ...
    q2 = st.radio("", ["長時間待在冷氣房，循環緩慢且手腳冰冷", "工作忙碌常熬夜，晚餐不規律導致不適", "壓力大節奏快，晚上難以入眠且心神不寧"], index=None, key="v211_q2")
    ...
    q3 = st.radio("", ["感覺臉龐恢復紅潤元氣，重新出發", "感覺身體找回輕盈律動，不再束縛", "感覺內心恢復安靜穩定，優雅從容"], index=None, key="v211_q3")
    ...
    choice = st.radio("", ["是的，我是新朋友", "不是，我是老朋友了（已有隨行杯）"], index=None, key="v211_choice")
