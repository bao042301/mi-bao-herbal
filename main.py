...
st.markdown("""
    ...
    * { color: #4A4E31 !important; font-family: 'Noto Sans TC', sans-serif !important; }
    ...
    /* Logo 尺寸恢復 (不縮得太小) */
    [data-testid="stImage"] img { max-height: 90px !important; width: auto !important; margin: 0 auto; display: block; }
    [data-testid="stImage"] { margin-bottom: -25px !important; }
    ...
    /* 【強力修正】徹底移除 Radio 黑點 (恢復 V26 穩定邏輯) */
    [data-testid="stRadio"] div[role="radiogroup"] input { display: none !important; }
    [data-testid="stRadio"] div[role="radiogroup"] div[data-testid="stMarkdownContainer"] { margin-left: 0 !important; }
    ...
    /* 【精準三色網底】 */
    [data-testid="stRadio"] div[role="radiogroup"] > div:nth-of-type(1) label { background-color: #F1F4E8 !important; } /* 綠 */
    [data-testid="stRadio"] div[role="radiogroup"] > div:nth-of-type(2) label { background-color: #FDF2E9 !important; } /* 杏 */
    [data-testid="stRadio"] div[role="radiogroup"] > div:nth-of-type(3) label { background-color: #EBF5FB !important; } /* 藍 */
...
if st.session_state.step == 1:
    ...
    q1 = st.radio("", ["我有些疲累，渴望溫潤透亮的晨光...", "我有些沉重，想找回輕盈自在的微風...", "我有些燥熱，想念山間清徹甘甜的泉水..."], index=None, key="v26_q1")
    ...
    q2 = st.radio("", ["長時間待在冷氣房，循環緩慢且手腳冰冷", "工作忙碌常熬夜，晚餐不規律導致不適", "壓力大節奏快，晚上難以入眠且心神不寧"], index=None, key="v26_q2")
    ...
    q3 = st.radio("", ["感覺臉龐恢復紅潤元氣，重新出發", "感覺身體找回輕盈律動，不再束縛", "感覺內心恢復安靜穩定，優雅從容"], index=None, key="v26_q3")
    ...
    choice = st.radio("", ["是的，我是新朋友", "不是，我是老朋友了（已有隨行杯）"], index=None, key="v26_choice")
    ...
    st.markdown("<div style='background-color: #FFFFFF; padding: 15px; border-radius: 12px; border: 1px solid #E9EDC9; font-size:0.85rem;'>首購禮遇：為妳在隨行杯木蓋上，鐫刻專屬的名字。</div>", unsafe_allow_html=True)
    ...
    <div class="result-card">
        <h3 style='margin:0; font-size:1.4rem !important;'>✨ 妳是：{diag}女子</h3>
        ...
        <p style='font-size:0.85rem; line-height:1.6;'>
            <b>陪伴清單包含：</b><br>
            • <b>40 入</b> 深度節律漢方茶組<br>
            • <b>植感生活語錄收藏卡</b><br>
            {gift_detail}
        </p>
        <p style='text-align:right; color:#7A8450; font-size: 1rem; font-weight: bold; margin-top:5px;'>陪伴價 $1,980</p>
    </div>
    """, unsafe_allow_html=True)
